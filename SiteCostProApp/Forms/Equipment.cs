...
namespace SiteCostProApp.Forms
{
    public partial class Equipment : Form
    {
        ...
        private void Equipment_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.Columns[0].HeaderText = "Equipment Name";
            dataGridView1.Columns[1].HeaderText = "Usage Time";
        ...
        private void dataGridView1_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 1 || e.ColumnIndex == 3) // Quantity or Unit Price column index
            {
                try
                {
                    ...
                    var usageTimeCell = dataGridView1.Rows[e.RowIndex].Cells[1].Value;
                    var unitPriceCell = dataGridView1.Rows[e.RowIndex].Cells[3].Value;

                    if (usageTimeCell != null && unitPriceCell != null)
                    {
                        if (decimal.TryParse(usageTimeCell.ToString(), out decimal quantity) &&
